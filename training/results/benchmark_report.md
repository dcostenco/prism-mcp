...
| Metric | Score |
|--------|-------|
| **Tool-Call Accuracy** | 84.6% |
| **JSON Validity** | 97.4% |
| **Parameter Accuracy** | 59.0% |
| **Avg Latency** | 2454ms |
| **Tokens/Second** | 31.8 |
| **Avg Tokens/Response** | 77 |
...
| 6 | ❌ | tool_call | Run a health check on the memory system | session_health_check | None |
...
| 11 | ❌ | tool_call | Upvote that memory about the RBAC fix — it was rea | knowledge_upvote | memory_upvote |
...
| 21 | ❌ | tool_call | Verify HIPAA compliance for the new data storage e | hipaa | session_hipaa_verify |
...
| 36 | ❌ | edge_case | Can you check if the memory system is healthy and  | session_health_check | INVALID_JSON |
| 37 | ❌ | edge_case | I want to clean up — compact and then export the p | session_compact_ledger | session_export_memory |
...
---
*Generated at 2026-04-28 06:10:13*
