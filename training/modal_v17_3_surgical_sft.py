...
Volumes:
  ...
  prism-sft-data   input  — /train_v17_3.jsonl
  prism-v17-3      output — /v17_3_adapter
"""
...
app = modal.App("prism-v17-3-surgical")
...
OUT_VOL = modal.Volume.from_name("prism-v17-3", create_if_missing=True)
...
def run_surgical_sft():
    ...
    data_path = Path("/data/train_v17_3.jsonl")
    ...
    Path("/out/v17_3_meta.json").write_text(json.dumps(meta, indent=2))
    OUT_VOL.commit()
    return meta
...
def run():
    ...
    print("\nFetch adapter:")
    print("  modal volume get prism-v17-3 v17_3_adapter ./v17_3_adapter --force")
