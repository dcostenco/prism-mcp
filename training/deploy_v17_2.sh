...
#
# Usage:
#   bash deploy_v17_2.sh
#
# Pre-conditions:
#   - Modal training app `prism-v17-2-surgical` has completed successfully
#   - prism-v17-2 Modal volume contains /v17_2_adapter
#
# Post-conditions:
#   - Local: /Users/admin/prism/training/models/v17_2_modal/v17_2_adapter
#   - Local: /Users/admin/prism/training/models/prism-v17-2-fused (BF16 HF)
#   - Local: /Users/admin/prism/training/models/prism-v17-2-fused-q4km.gguf
#   - Ollama: prism-coder:7b-v17-2 tag registered
#   - Eval report: /tmp/v17_2_deploy_report.md
#
...
LOG=/tmp/v17_2_deploy.log
REPORT=/tmp/v17_2_deploy_report.md
ADAPTER_LOCAL=/Users/admin/prism/training/models/v17_2_modal/v17_2_adapter
FUSED_DIR=/Users/admin/prism/training/models/prism-v17-2-fused
GGUF_OUT=/Users/admin/prism/training/models/prism-v17-2-fused-q4km.gguf
MODELFILE=/tmp/Modelfile.v17-2
OLLAMA_TAG=prism-coder:7b-v17-2
...
log "[1/6] Fetching adapter from prism-v17-2 volume..."
mkdir -p "$(dirname "$ADAPTER_LOCAL")"
modal volume get prism-v17-2 v17_2_adapter "$(dirname "$ADAPTER_LOCAL")/" --force 2>&1 | tail -10 | tee -a "$LOG"
...
modal volume get prism-v17-2 v17_2_meta.json /tmp/v17_2_meta.json --force 2>&1 | tail -3 | tee -a "$LOG" || log "WARN: v17_2_meta.json not fetched"
...
log "[6/6] Building deploy report..."
{
  ...
  echo '```json'
  cat /tmp/v17_2_meta.json 2>/dev/null | python3 -m json.tool 2>/dev/null || echo "(no meta)"
  echo '```'
  echo
  echo "## Next step"
  echo "Run \`bash run_full_eval_v17_2.sh\` to evaluate."
  echo
