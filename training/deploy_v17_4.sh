...
#
# Usage:
#   bash deploy_v17_4.sh
#
# Pre-conditions:
#   - Modal training app `prism-v17-4-surgical` has completed successfully
#   - prism-v17-4 Modal volume contains /v17_4_adapter
#
# Post-conditions:
#   - Local: /Users/admin/prism/training/models/v17_4_modal/v17_4_adapter
#   - Local: /Users/admin/prism/training/models/prism-v17-4-fused (BF16 HF)
#   - Local: /Users/admin/prism/training/models/prism-v17-4-fused-q4km.gguf
#   - Ollama: prism-coder:7b-v17-4 tag registered
#   - Eval report: /tmp/v17_4_deploy_report.md
#
...
LOG=/tmp/v17_4_deploy.log
REPORT=/tmp/v17_4_deploy_report.md
ADAPTER_LOCAL=/Users/admin/prism/training/models/v17_4_modal/v17_4_adapter
FUSED_DIR=/Users/admin/prism/training/models/prism-v17-4-fused
GGUF_OUT=/Users/admin/prism/training/models/prism-v17-4-fused-q4km.gguf
MODELFILE=/tmp/Modelfile.v17-4
OLLAMA_TAG=prism-coder:7b-v17-4
...
log "[1/6] Fetching adapter from prism-v17-4 volume..."
mkdir -p "$(dirname "$ADAPTER_LOCAL")"
modal volume get prism-v17-4 v17_4_adapter "$(dirname "$ADAPTER_LOCAL")/" --force 2>&1 | tail -10 | tee -a "$LOG"
...
modal volume get prism-v17-4 v17_4_meta.json /tmp/v17_4_meta.json --force 2>&1 | tail -3 | tee -a "$LOG" || log "WARN: v17_4_meta.json not fetched"
...
log "[6/6] Building deploy report..."
{
  ...
  echo '```json'
  cat /tmp/v17_4_meta.json 2>/dev/null | python3 -m json.tool 2>/dev/null || echo "(no meta)"
  echo '```'
  echo
  echo "## Next step"
  echo "Run \`bash run_full_eval_v17_4.sh\` to evaluate."
  echo
