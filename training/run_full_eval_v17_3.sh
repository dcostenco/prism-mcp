...
#
# Output: /tmp/v17_3_full_eval.md

set -uo pipefail

MODEL_TAG="${MODEL_TAG:-prism-coder:7b-v17-3}"
BASE_DIR=/Users/admin/prism/training
REPORT=/tmp/v17_3_full_eval.md
LOG=/tmp/v17_3_full_eval.log
START_TS=$(date +%s)
...
for run in 1 2 3; do
  log "  run $run/3..."
  RUN_LOG="/tmp/bfcl_v17_3_run${run}.log"
...
CARE_LOG=/tmp/v17_3_caregiver_targeted.log
...
FORMAT_LOG=/tmp/v17_3_format_probe.log
