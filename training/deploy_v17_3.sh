...
#
# Usage:
#   bash deploy_v17_3.sh
#
# Pre-conditions:
#   - Modal training app `prism-v17-3-surgical` has completed successfully
#   - prism-v17-3 Modal volume contains /v17_3_adapter
#
# Post-conditions:
#   - Local: /Users/admin/prism/training/models/v17_3_modal/v17_3_adapter
#   - Local: /Users/admin/prism/training/models/prism-v17-3-fused (BF16 HF)
#   - Local: /Users/admin/prism/training/models/prism-v17-3-fused-q4km.gguf
#   - Ollama: prism-coder:7b-v17-3 tag registered
#   - Eval report: /tmp/v17_3_deploy_report.md
#
...
LOG=/tmp/v17_3_deploy.log
REPORT=/tmp/v17_3_deploy_report.md
ADAPTER_LOCAL=/Users/admin/prism/training/models/v17_3_modal/v17_3_adapter
FUSED_DIR=/Users/admin/prism/training/models/prism-v17-3-fused
GGUF_OUT=/Users/admin/prism/training/models/prism-v17-3-fused-q4km.gguf
MODELFILE=/tmp/Modelfile.v17-3
OLLAMA_TAG=prism-coder:7b-v17-3
...
log "[1/6] Fetching adapter from prism-v17-3 volume..."
mkdir -p "$(dirname "$ADAPTER_LOCAL")"
modal volume get prism-v17-3 v17_3_adapter "$(dirname "$ADAPTER_LOCAL")/" --force 2>&1 | tail -10 | tee -a "$LOG"
...
modal volume get prism-v17-3 v17_3_meta.json /tmp/v17_3_meta.json --force 2>&1 | tail -3 | tee -a "$LOG" || log "WARN: v17_3_meta.json not fetched"
...
log "[6/6] Building deploy report..."
{
  ...
  echo '```json'
  cat /tmp/v17_3_meta.json 2>/dev/null | python3 -m json.tool 2>/dev/null || echo "(no meta)"
  echo '```'
  echo
  echo "## Next step"
  echo "Run \`bash run_full_eval_v17_3.sh\` to evaluate."
  echo
